...
int main(int argc, char *argv[]) {
  ...
  //uint8_t sequence_layer[] = { 0x40, 0x01, 0x00, 0x05};
  uint8_t sequence_layer[] = { 0x0f, 0xf1, 0x80, 0x01};
  AVCodec * wmv3 = NULL;
  ...
  sprintf (exec_buf, "display -size 320x240 -depth 8 -delay 1 rgb:%s", argv[2]);
